...
const LocationDetailScreen3 = ({ navigation }) => {
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.locationConfirmBox}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('DetailAmbulance')} // Navigate to DetailAmbulance screen
        >
...
export default LocationDetailScreen3;
